  ...
  module Extensions
    module Assets extend self
      ...
      def registered(app)
        ...
        app.set :precompile, precompile = %w{ vendor/jquery.js vendor/jquery-ui.js bootstrap.js marketing.js board/application.js marketing.css flex_layout.css application.css splash.css bootstrap.css *.png }
