...
module HuBoard
  module Extensions
    module Assets extend self
      ...
      PRECOMPILED_ASSETS = %w{ember-accounts.js vendor/jquery.js vendor/jquery-ui.js bootstrap.js marketing.js board/application.js marketing.css flex_layout.css application.css splash.css marketing/main.css bootstrap.css bootstrap-datepicker.css *.png *.jpg}
